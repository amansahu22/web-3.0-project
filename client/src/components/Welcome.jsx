            ...
            <div className='flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4'>
                ...
                <div className='flex flex-col flex-1 items-center justify-center w-full mf:mt-0 mt-10'>
                    ...
                    <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
                        ...
                        <Input placeholder='Amount (ETH)' name='address' type='number' handleChange={() => { }} />
...

                        {
                            isLoading ? (<Loader />) : (
                                <button
                                    ...
                                    className='w-full text-white mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full hover:bg-[#2952e3] cursor-pointer'
                                >
                                    Send Now
                                </button>
                            )
